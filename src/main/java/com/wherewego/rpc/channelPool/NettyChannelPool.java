package com.wherewego.rpc.channelPool;
...
public class NettyChannelPool {
     ...
     * 同步获取netty channel
     */
    public Channel syncGetChannel(CallbackHandler callback) throws InterruptedException {
        ...
        synchronized (locks[index]) {
            ...
            //开始跟服务端交互，获取channel
            channel = connectToServer(callback);
    ...
    private Channel connectToServer(final CallbackHandler callback) throws InterruptedException {
        ...
        bootstrap.group(eventLoopGroup)
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast(new TcpClientHandler(callback));
                    }
                });

        LOGGER.info("客户端建立连接");
        ChannelFuture channelFuture = bootstrap.connect(config.getRemoteHost(), config.getRemotePort());
